...
/**
 * minWith() - 依 Comparator 找出最小元素，若是 Empty 集合則拋出 NoSuchElementException
 */
...
// 示範使用方式
cart.minWith(compareBy{ it.amount })
emptyListOfOrderItem.minWith(compareBy { it.amount })
listOfNothing.minWith(compareBy { it.amount })
